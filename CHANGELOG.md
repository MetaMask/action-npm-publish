...
## [4.0.5]
### Fixed
- Add missing configuration for non-default Slack channel messages ([#83](https://github.com/MetaMask/action-npm-publish/pull/83))
...
[Unreleased]: https://github.com/MetaMask/action-npm-publish/compare/v4.0.5...HEAD
