...
- feat: Update Slack message to link to staged publish instructions ([#118](https://github.com/MetaMask/action-npm-publish/pull/118))
...
[Unreleased]: https://github.com/MetaMask/action-npm-publish/compare/v6.1.0...HEAD
