...
- feat!: Add support for NPM staged publishing ([#112](https://github.com/MetaMask/action-npm-publish/pull/112))
- Bump Yarn to `4.16.0` ([#115](https://github.com/MetaMask/action-npm-publish/pull/115))
- chore: Bump Yarn to v4, align workflows with module template ([#114](https://github.com/MetaMask/action-npm-publish/pull/114))
- chore!: Drop support for Node.js <22 ([#113](https://github.com/MetaMask/action-npm-publish/pull/113))
