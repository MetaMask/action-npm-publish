...
- Add option to disable provenance ([#120](https://github.com/MetaMask/action-npm-publish/pull/120))

### Fixed

- Disable provenance for private repositories ([#120](https://github.com/MetaMask/action-npm-publish/pull/120))
  - Provenance is not supported for private repositories.
